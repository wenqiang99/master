...
using MyPractice.Authentication.JwtBearer;
...
namespace MyPractice
{
    ...
    public class MyPracticeWebCoreModule : AbpModule
    {
        ...
        public MyPracticeWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyPracticeWebCoreModule).GetAssembly());
        }

        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MyPracticeWebCoreModule).Assembly);
        }
    }
}
