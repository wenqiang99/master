...
namespace MyPractice.Util.Common
{
    public class FileHelper
    {
        ...
        public static double GetFileSizeByKB(string filePath)
        {
            ...
            FileInfo fi = new FileInfo(filePath);
            //获取文件的大小 
            double fileLength = ObjectConverter.Object2Double(fi.Length);
            return ObjectConverter.Object2Double(fileLength / 1024);
        }
        ...
        public static double GetFileSizeByMB(string filePath)
        {
            ...
            //获取文件的大小 
            double fileLength = ObjectConverter.Object2Double(fi.Length);
            return ObjectConverter.Object2Double(fileLength / 1024 / 1024);
        }
        #endregion

        #region 获取指定目录中的文件列表
        /// <summary> 
        /// 获取指定目录中所有文件列表(只包括文件名)
        /// </summary> 
        /// <param name="directoryPath">指定目录的绝对路径</param>         
        ...
        public static byte[] StreamToBytes(Stream stream)
        {
            try
            {
                ...
                //读取流 
                stream.Read(buffer, 0, ObjectConverter.Object2int(stream.Length));
        ...
        /// 返回指定路径的扩展名 
        /// </summary> 
        /// <param name="filePath">文件的绝对路径或文件名</param>         
        ...
        /// <param name="env"></param>
        /// <returns></returns>
        public static string GetWebRootPath(IHostingEnvironment env)
        {
            //来取得Web根目录和内容根目录的物理路径
        ...
        /// <param name="env"></param>
        /// <returns></returns>
        public static string GetContentRootPath(IHostingEnvironment env)
        {
        ...
        /// </summary> 
        /// <param name="filePath">文件的相对路径</param> 
        public static void DelRelativeFile(string filePath)
        {
            string path = FileHelper.GetAbsolutePath(filePath);
            FileHelper.DeleteFile(path);
        }
        #endregion

        #region 根据文件相对路径删除文件所属的文件及底下的所有文件
        /// <summary> 
        /// 根据文件相对路径删除文件所属的文件及底下的所有文件
        /// </summary> 
        /// <param name="filePath">文件的相对路径</param> 
        public static void DelFolderAndFile(string filePath)
        {
