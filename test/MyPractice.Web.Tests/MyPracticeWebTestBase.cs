...
{
    public abstract class MyPracticeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyPracticeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyPracticeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyPracticeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyPracticeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyPracticeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyPracticeDbContext, Task<T>> func)
        {
            T result;
